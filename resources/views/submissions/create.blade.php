...
@section('content')
    ...
    @if ($existingSubmission)
        <div class="alert alert-info">
            Anda sudah mengajukan permohonan sebelumnya.
        </div>
    @else
        <form action="{{ route('submissions.store') }}" method="post" enctype="multipart/form-data" class="row g-2">
            ...
            <div class="col-md-6">
                ...
                <input type="number" class="form-control @error('phone') is-invalid @enderror" name="phone"
                    id="phone" placeholder="Masukkan No Telepon Anda" value="{{ old('phone') }}" maxlength="15">
                @error('phone')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="col-md-6">
                ...
                <input type="date" class="form-control @error('tanggal_pengajuan') is-invalid @enderror"
                    name="tanggal_pengajuan" id="tanggal_pengajuan" value="{{ old('tanggal_pengajuan') }}">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control @error('ibadah') is-invalid @enderror" name="ibadah"
                    id="ibadah" placeholder="Masukkan nama Tempat Ibadah Secara Lengkap" value="{{ old('ibadah') }}">
                @error('ibadah')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            <div class="col-md-6">
                ...
                <div class="input-group">
                    ...
                    <input type="number" class="form-control @error('budget') is-invalid @enderror" name="budget"
                        id="budget" placeholder="Masukkan Nominal Rencana Anggaran Biaya"
                        value="{{ old('budget') }}">
                </div>
                @error('budget')
                    <div class="invalid-feedback">{{ $message }}</div>
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control @error('bank_account') is-invalid @enderror"
                    name="bank_account" placeholder="Masukkan No Rekening Dengan Atas Nama Ibadah" id="bank_account"
